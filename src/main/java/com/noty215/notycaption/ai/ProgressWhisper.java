...
public class ProgressWhisper {
    ...
    public <T> T transcribeWithProgress(WhisperModel model, String audioPath, 
        ...
        // In real implementation, this would call the actual transcription with progress callbacks
