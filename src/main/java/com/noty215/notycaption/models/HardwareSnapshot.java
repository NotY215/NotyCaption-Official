...
/**
 * Hardware snapshot data class for monitoring history
 */
public class HardwareSnapshot {
    ...
    public HardwareSnapshot(LocalDateTime timestamp, double cpuUsage, double cpuTemp, double cpuFreq,
                            double cpuPower, List<Double> gpuUsage, List<Double> gpuTemp, List<Long> gpuMemory,
                            List<Double> gpuPower, double ramUsage, long ramAvailable, double swapUsage,
                            Map<String, Double> diskUsage, Map<String, long[]> diskIo, long[] networkIo,
                            Double batteryPercent, int processCount, int threadCount, int handleCount,
                            long uptime, double[] loadAverage) {
