...
public class PerformanceGraphWidget extends JPanel {
    ...
    private void initUI() {
        ...
        controlPanel.add(new JLabel(translator.tr("performance") + ":"));
        ...
        JButton exportBtn = new JButton(translator.tr("export"));
    ...
    private double getValue(HardwareSnapshot snapshot) {
        switch (graphType) {
            ...
            case NETWORK:
                ...
                return 0;
            case DISK:
                Map<String, Double> diskUsage = snapshot.getDiskUsage();
    ...
    private void exportGraph() {
        ...
        chooser.setSelectedFile(new java.io.File("performance_graph.png"));
